        ...
        <div class="container mx-auto px-4 tablet:px-6 desktop:px-8 ">
            <div class="flex w-full flex-wrap justify-between">
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/gEti8-XKhDo?si=4RFcxL9euYdommEz"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 26 November 2023 ) Ps. Joel Manalu, M.Th ( Memberkati & Mengutuk )</h6>
                    </a>
                </div>
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/fJ4crnR1hM8?si=ocI_nbCRbr3EAwMu"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 19 November 2023 ) Bp. Joe Wijaya ( Kemurahan Hati Tuhan )</h6>
                    </a>
                </div>
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/01s8L8bwOk4?si=gkiaG4B5GYEIB_lD"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 12 November 2023 ) Ps. June Nendissa, S.Th ( Kebaikan Tuhan )</h6>
                    </a>
                </div>
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/PLYoIHj4WFg?si=iXQdS2EWEQYvq2J3"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 5 Oktober 2023 ) Ps. Joel Manalu, M.Th ( Kemuliaan Tuhan )</h6>
                    </a>
                </div>
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/lU_Qj_uh1uQ?si=2pxJXaLzQjXUKTuv"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 29 Oktober 2023 ) Ev. Shandra Irawati, M.Th ( Anak-anak Allah )</h6>
                    </a>
                </div>
                <div class="my-5 w-full tablet:w-[48%] desktop:w-[30%]">
                    <iframe class="w-full rounded-lg" style="aspect-ratio:3/2" src="https://www.youtube.com/embed/VUjxpdgFSdw?si=UV2kMqdLsXUGgiFl"></iframe>
                    <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank">
                        <h6 class="mt-2 font-bold">Ibadah Raya (Minggu, 22 Oktober 2023 ) Ps. Joel Manalu, M.Th ( Identitas Orang Percaya )</h6>
                    </a>
                </div>
            </div>
        </div>
