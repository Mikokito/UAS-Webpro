            ...
            <div class="container mx-auto px-4 tablet:px-6 desktop:px-8">
                <nav class="flex items-center justify-between" aria-label="Global">
                    ...
                    <div class="hidden items-center desktop:flex">
                        <a href="{{ route('home.index') }}" class="px-4 py-6 text-sm font-semibold uppercase leading-6 text-white hover:bg-brand">Home</a>
                        <a href="{{ route('service.index') }}" class="px-4 py-6 text-sm font-semibold uppercase leading-6 text-white hover:bg-brand">Services</a>
                        <a href="{{ route('media.show') }}" class="px-4 py-6 text-sm font-semibold uppercase leading-6 text-white hover:bg-brand">Media</a>
                        <a href="/#" class="px-4 py-6 text-sm font-semibold uppercase leading-6 text-white hover:bg-brand">Ministries</a>
                    </div>
                </nav>
            </div>
        </header>
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6">
                        <div class="space-y-2 py-6">
                            <a href="{{ route('home.index') }}" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold uppercase leading-7 text-white hover:bg-brand">Home</a>
                            <a href="{{ route('service.index') }}" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold uppercase leading-7 text-white hover:bg-brand">Services</a>
                            <a href="{{ route('media.show') }}" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold uppercase leading-7 text-white hover:bg-brand">Media</a>
                            <a href="/#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold uppercase leading-7 text-white hover:bg-brand">Ministries</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="mt-16 grid grid-cols-2 gap-8 desktop:col-span-6 desktop:mt-0 desktop:grid-cols-6">
                        <div class="space-y-8 col-span-2">
                            ...
                            <h3 class="text-sm leading-6 text-link mt-0" style="margin-top: 15px !important;">
                                Ruko Alicante Blok A55, Jl. Jendral Gatot Subroto C10 Gading Serpong, Medang, Pagedangan, Tangerang Regency, Banten 15334
                            </h3>
                        </div>
                            <!-- Churches Section -->
                            <!-- Services Section -->
                            <div>
                                ...
                                <ul role="list" class="mt-6 list-outside list-none space-y-4 pl-0">
                                    <li><a href="{{ route('service.index') }}" class="text-sm leading-6 text-link hover:text-light">Family</a></li>
                                    <li><a href="{{ route('service.index') }}" class="text-sm leading-6 text-link hover:text-light">Senior</a></li>
                                    <li><a href="{{ route('service.index') }}" class="text-sm leading-6 text-link hover:text-light">Army</a></li>
                                    <li><a href="{{ route('service.index') }}" class="text-sm leading-6 text-link hover:text-light">Kids</a></li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul role="list" class="mt-6 list-outside list-none space-y-4 pl-0">
                                    <li><a href="{{ route('media.show') }}" class="text-sm leading-6 text-link hover:text-light">Youtube</a></li>
                                    <li><a href="{{ route('media.show') }}" class="text-sm leading-6 text-link hover:text-light">Instagram</a></li>
                                    <li><a href="{{ route('media.show') }}" class="text-sm leading-6 text-link hover:text-light">Facebook</a></li>
                                    <li><a href="{{ route('media.show') }}" class="text-sm leading-6 text-link hover:text-light">Schedule</a></li>
                                </ul>
                            </div>
                            <!-- Connect Section -->
                            <div>
                                <h3 class="text-sm font-semibold uppercase leading-6 text-light">Ministries</h3>
                                <ul role="list" class="mt-6 list-outside list-none space-y-4 pl-0">
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                            ...
                            <!-- Mission -->
                            <div>
                                <h3 class="text-sm font-semibold uppercase leading-6 text-light">Test</h3>
                                <ul role="list" class="mt-6 list-outside list-none space-y-4 pl-0">
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                                    <li><a href="/#" class="text-sm leading-6 text-link hover:text-light">Test</a></li>
                ...
                <div class="container mx-auto px-4 tablet:px-6 desktop:px-8 ">
                    <div class="flex flex-col items-center desktop:flex-row desktop:justify-between">
                        <div class="flex justify-center space-x-6 desktop:order-2">
                            <a href="https://www.facebook.com/profile.php?id=100076716421749" target="_blank" rel="noreferrer" class="text-link hover:text-light">
                            ...
                            <a href="https://www.instagram.com/gbinlc.gadingserpong" target="_blank" rel="noreferrer" class="text-link hover:text-light">
                            ...
                            <a href="https://www.youtube.com/@gbinlcgadingserpong849" target="_blank" rel="noreferrer" class="text-link hover:text-light">
